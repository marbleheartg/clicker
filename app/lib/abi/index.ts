 ...
 */
export const useReadContractGetPlayerCount = /*#__PURE__*/ createUseReadContract({
  abi: contractAbi,
 ...
 */
export const useReadContractGetTopPlayers = /*#__PURE__*/ createUseReadContract({ abi: contractAbi, functionName: "getTopPlayers" })
 ...
 */
export const useSimulateContractClick = /*#__PURE__*/ createUseSimulateContract({ abi: contractAbi, functionName: "click" })

/**
 * Wraps __{@link useSimulateContract}__ with `abi` set to __{@link contractAbi}__ and `functionName` set to `"initialize"`
 */
export const useSimulateContractInitialize = /*#__PURE__*/ createUseSimulateContract({
  abi: contractAbi,
  functionName: "initialize",
})
 ...
 */
export const useSimulateContractWithdraw = /*#__PURE__*/ createUseSimulateContract({
  abi: contractAbi,
  functionName: "withdraw",
})
 ...
 */
export const useWatchContractInitializedEvent = /*#__PURE__*/ createUseWatchContractEvent({
  abi: contractAbi,
